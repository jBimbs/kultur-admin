...
export default function AddArtifactPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch("/api/artifacts/add", {
        method: "POST",
        body: formData,
      });
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600 dark:text-slate-400">
            Add a new artifact to your collection with details and image.
          </p>
        </div>
        <Link href="/artifacts/view-artifacts">
          <Button variant="outline">Back to artifacts</Button>
        </Link>
      </div>
      ...
      {step === "details" && (
        <Card className="border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
          <CardHeader>
            ...
            <CardDescription>Enter the basic information about the artifact.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                placeholder="e.g., National Museum, Exhibit Hall A"
            ...
            <div className="flex gap-3 pt-4">
              <Link href="/artifacts/view-artifacts" className="flex-1">
      ...
      {step === "image" && (
        <Card className="border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
          <CardHeader>
            ...
            <CardDescription>Upload a high-quality image of the artifact (max 5MB).</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="space-y-2">
      ...
      {step === "confirmation" && (
        <Card className="border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
          <CardHeader>
            ...
            <CardDescription>Please review the artifact details before adding.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="grid gap-6 sm:grid-cols-2">
              <div className="space-y-4 sm:col-span-2">
                ...
                <div>
                  <p className="text-xs font-semibold text-slate-500 dark:text-slate-400">Current Location</p>
                  <p className="mt-1 text-sm text-slate-900 dark:text-slate-100">{currentLocation}</p>
                </div>
              </div>
              {imagePreview && (
